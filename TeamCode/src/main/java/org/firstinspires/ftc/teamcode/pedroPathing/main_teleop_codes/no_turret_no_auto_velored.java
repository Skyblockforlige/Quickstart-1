...
@Configurable
@Config
@TeleOp(name="no auto_velo RED")
public class no_turret_no_auto_velored extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            */
            ...
            telemetry.addData("Shooter REAL velocity", flywheel.getVelocity());
