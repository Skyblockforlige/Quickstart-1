...
@Configurable
@Config
@Autonomous(name = "Far Side Back and Forth - RED")
public class farsideautobackandforthred extends OpMode {
    ...
    public void autonomousPathUpdate() {
        ...
        switch (pathState) {
            case 0:
                ...
                spindexerspeed=0.1;
                targetTicksPerSecond=rconstants.shootfar+25;
...
*/
        ...
        spindexer.setPower(0.8*(-cs1.calculate(current2)));
