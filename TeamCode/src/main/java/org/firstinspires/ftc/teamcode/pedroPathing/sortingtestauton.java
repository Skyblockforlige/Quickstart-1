...
@Config
@Autonomous
public class sortingtestauton extends OpMode {
    ...
    public void buildPaths() {
        firstpath = follower
                ...
                .setLinearHeadingInterpolation(Math.toRadians(145), Math.toRadians(55))
                .addPath(
                        new BezierLine(new Pose(31.345, 116.100), new Pose(31.345, 116.100))
                )
