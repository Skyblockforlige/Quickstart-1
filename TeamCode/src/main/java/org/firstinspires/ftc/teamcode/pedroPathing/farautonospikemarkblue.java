...
@Configurable
@Config
@Autonomous(name = "farautonospikemarkblue", group = "Examples")
public class farautonospikemarkblue extends OpMode {
    ...
    private final Pose startPose = new Pose(87.0, 8, Math.toRadians(90)).mirror();
    ...
    public void buildPaths() {
        Path1 = follower.pathBuilder().addPath(
                        new BezierLine(
                                new Pose(87.000, 8.000).mirror(),

                                new Pose(87.000, 19.000).mirror()
                        )
        ...
        Path2 = follower.pathBuilder().addPath(
                        new BezierLine(
                                ...
                                new Pose(144.109, 25.220).mirror()
                        )
        ...
        Path3 = follower.pathBuilder().addPath(
                        new BezierLine(
                                ...
                                new Pose(146.716, 21.979).mirror()
                        )
        ...
        Path5 = follower.pathBuilder().addPath(
                        new BezierLine(
                                ...
                                new Pose(130.000, 19.000).mirror()
                        )
    ...
    public void autonomousPathUpdate() {
        ...
        switch (pathState) {
            ...
            case 6:
                ...
                if(spindexer.getCurrentPosition()>= (11*rconstants.movespindexer-800)&&flywheel.getVelocity()>=1500){
                    transfermover.setPosition(rconstants.transfermoverfull);
                    spindexerspeed=1;
                    setPathState(6);
            ...
            case 12:
                ...
                if(spindexer.getCurrentPosition()>= (18*rconstants.movespindexer-800)){
                    transfermover.setPosition(rconstants.transfermoverfull);
                    setPathState(13);
            ...
            case 16:
                ...
                if(spindexer.getCurrentPosition()>= (25*rconstants.movespindexer-800)){
                    transfermover.setPosition(rconstants.transfermoverfull);
                    setPathState(17);
