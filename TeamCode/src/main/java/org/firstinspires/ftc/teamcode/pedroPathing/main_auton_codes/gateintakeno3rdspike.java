...
public class gateintakeno3rdspike extends OpMode {
    ...
    private final Pose startPose = new Pose(27.463, 131.821, Math.toRadians(143));
    ...
    public void buildPaths() {
        Path1 = follower.pathBuilder()
                .addPath(
                        new BezierLine(
                                new Pose(27.463, 131.821),
                                new Pose(45.005, 112.859)
                        )
                )
        ...
        Path2 = follower.pathBuilder()
                .addPath(
                        new BezierCurve(
                                new Pose(43.796, 99.812),
                                new Pose(63, 56.8),
                                new Pose(20.500, 59.600)
                        )
                )
