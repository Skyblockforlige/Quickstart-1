...
public class gateintakeauto extends OpMode {
    ...
    public void buildPaths() {
        ...
        Path3 = follower
                ...
                .build();
        Path67  = follower.pathBuilder()
                .addPath(
                        new BezierCurve(
                                new Pose(33.345, 114.100),
                                new Pose(71.169, 55.795),
                                new Pose(18.530, 65.124)
                        )
                )
                .setLinearHeadingInterpolation(Math.toRadians(133.5), Math.toRadians(155))
                .build();
        Path68 = follower.pathBuilder()
                .addPath(
                        new BezierLine(
                                new Pose(18.530, 65.624),
                                new Pose(22.074, 63.765)
                        )
                )
