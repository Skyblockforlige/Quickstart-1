...
@Config
@Disabled
@Autonomous(name = "3 ball red - w cosmo", group = "Examples")
public class threeballcosmored extends OpMode {
    ...
    public void buildPaths() {
        firstpath = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(27.463, 131.821).mirror(), new Pose(48.71447902571042, 131.3342354533153).mirror())
                )
                .setLinearHeadingInterpolation(Math.toRadians(35), Math.toRadians(7))
                .build();
