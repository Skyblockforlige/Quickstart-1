...
@Configurable
@Config
@Autonomous(name = "12 Ball Sort- Red")
public class twelveballsortedred extends LinearOpMode {
    ...
    public static double p3=0.00035,i3=0.0000000005,d3=0.0000000002;
    ...
    private final Pose startPose = new Pose(27.463, 131.821, Math.toRadians(35));
