...
@Configurable
@Config
@TeleOp(name="Shooting on the move- Blue")
public class shootingwhilemoving extends LinearOpMode {
    ...
    // ONLY SHOWING MODIFIED + ADDED PARTS — everything else stays the same

    // ===================== ADD AT TOP =====================
    public static double kPassthru = 1.0;
    public static double kTime = 1.0;
    public static double kStrafe = 1.0;
