...
public class twelveballauto extends OpMode {
    ...
    public void buildPaths() {
        ...
        Path2 = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(51.000, 59.793), new Pose(26.500, 59.793))
                )
        ...
        Path3 = follower
                ...
                .addPath(
                        new BezierCurve(
                                ...
                                new Pose(52.500, 64.900),
                                new Pose(26.000, 70.000)
                        )
                )
        ...
        Path9 = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(51.000, 35.793), new Pose(26.000, 35.793))
                )
                .setConstantHeadingInterpolation(Math.toRadians(180))
                .build();
        ...
        Path10 = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(26.000, 35.793), new Pose(31.345, 116.379))
                )
                .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(133.5))
                .build();
