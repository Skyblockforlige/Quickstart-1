...
public class maahir_learning_arctan extends LinearOpMode {
    ...
    private Servo hood;
    GoBildaPinpointDriver ppDevice = null;
    ...
    public double wanted_turret_deg;
    ...
    // ===================== LIMELIGHT =====================
    // kept only for shooter distance logic
    ...
    public void runOpMode() {
        ...
        // limelight kept only for shooter distance
        ...
        while (opModeIsActive()) {
            ...
            double turretManual = -gamepad2.right_stick_x;
            turretL.setPower(servoDir * turretManual);
            turretR.setPower(servoDir * turretManual);

            turretdeg= turretEnc.getCurrentPosition()/ticksPerDegree;





            // ===================== LIMELIGHT FOR SHOOTER DISTANCE ONLY =====================
            ...
            if (spindexer.getCurrentPosition() % rconstants.movespindexer <= 100 ||
                    spindexer.getCurrentPosition() % rconstants.movespindexer >= rconstants.movespindexer - 100) {
            ...
            if (llResult != null && llResult.isValid()) {
                ...
                telemetry.addData("TA", "no target");
